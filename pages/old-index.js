...
import {Box, Heading, Text, Button, Grid, Divider, Flex, Stack, Link} from '@chakra-ui/core';
...
export default () => {
    return (
        <Box mb={20}>
            ...
            <Container>
                <Grid templateColumns={{sm: 'repeat(1, 1fr)', md: 'repeat(3, 1fr)'}} gap={10} px={{md: 12}}>
                    <Feature icon={MdAccessibility} title="Accessible">
                        Chakra UI strictly follows WAI-ARIA standards. All components come with proper attributes and
                        keyboard interactions out of the box.
                    </Feature>
                    <Feature icon={MdPalette} title="Themeable">
                        Quickly and easily reference values from your theme throughout your entire application, on any
                        component.
                    </Feature>
                    <Feature icon={MdGrain} title="Composable">
                        Components were built with composition in mind. You can leverage any component to create new
                        things.
                    </Feature>
                </Grid>
            </Container>
                ...
                <Box>
                    ...
                    >
                        <Box d={{md: 'flex'}} alignItems="flex-start">
                            ...
                            />
                            <Box size={8} />
                            <Box p={6} flex="1" rounded="10px" as={LivePreview} borderWidth="1px" />
                        </Box>
                        <Box as={LiveError} mt={4} bg="red.400" fontFamily="Menlo, monospace" color="white" p="1em" />
                    </LiveProvider>
                </Box>
            </Container>
            ...
            <Box as="footer" mt={12} textAlign="center">
                ...
                <Stack shouldWrapChildren mt={4} isInline spacing="12px" justify="center">
                    ...
                    <FooterLink href="https://twitter.com/thesegunadebayo" icon={IoLogoTwitter} />
                    <FooterLink href="https://linkedin.com/in/thesegunadebayo/" icon={IoLogoLinkedin} />
